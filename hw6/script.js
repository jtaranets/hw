...
class Hamburger {
  ...
  removeTopping(topping) {
    ...
    //   const indexOfTopping = this._toppings.indexOf(topping);
    //       this._toppings.splice(indexOfTopping, 1);
    console.log(this._toppings);
  }
   ...
   */
  calculatePrice() {
    let sumSize = Hamburger.SIZES[this._size].price;
    console.log(sumSize);
    let sumTop = this._toppings.reduce(
      (acc, el) => acc + Hamburger.TOPPINGS[el].price,
      0
    );
    console.log(sumTop);
    let sumStuf = Hamburger.STUFFINGS[this._stuffing].price;
    return sumSize + sumStuf + sumTop;
  }
  ...
  calculateCalories() {
    ...
    let calTop = this._toppings.reduce(
      (acc, el) => acc + Hamburger.TOPPINGS[el].calories,
      0
    );
    let calStuf = Hamburger.STUFFINGS[this._stuffing].calories;
    return calSize + calTop + calStuf;
  }
}
